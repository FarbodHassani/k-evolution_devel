...
for(x.first();x.test();x.next())
{
if (x.coord(0)==13 && x.coord(1)==32 && x.coord(2)==31){
cout<<x.coord(2)<<"+1 "<<phi(x+2)<<endl;
}

if (x.coord(0)==13 && x.coord(1)==32 && x.coord(2)==32){
cout<<x.coord(2)<<" "<<phi(x)<<endl;
}

if (x.coord(0)==13 && x.coord(1)==32 && x.coord(2)==33){
cout<<x.coord(2)<<" "<<phi(x)<<endl;
}
}
