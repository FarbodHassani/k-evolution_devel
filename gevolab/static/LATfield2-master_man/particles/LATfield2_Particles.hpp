...
public:
  ...
  bool addParticle_global(part newPart);
    ...
    Real updateVel2(Real (*updateVel_funct)(double,double,part*,double *,part_info,Field<Real> **,Site *,int,double*,double*,int,FILE*),
                   double dtau,
                   Field<Real> ** fields=NULL,
                   int nfields=0,
                   double * params=NULL,
    ...
    void moveParticles2( void (*move_funct)(double,double,part*,double *,part_info,Field<Real> **,Site *,int,double*,double*,int,FILE*),
                       double dtau,
                       Field<Real> ** fields=NULL,
                       int nfields=0,
                       double * params=NULL,
  ...
  void loadHDF5(string filename_base, int fileNumber);
    ...
    /*!
     Method to "count" number of particles.

     \param long num: number of particles.
     */
    void count(int* num);
...
/////////////////////////////////////////////////*/
template <typename part, typename part_info, typename part_dataType>
void Particles<part,part_info,part_dataType>::count(int* num)
{
*num=0;
parallel.barrier();
    Site x(lat_part_);
...
template <typename part, typename part_info, typename part_dataType>
Real Particles<part,part_info,part_dataType>::updateVel2(Real (*updateVel_funct)(double,double,part*,double *,part_info,Field<Real> **,Site *,int,double*,double*,int,FILE*),
               double dtau,
               Field<Real> ** fields,
               int nfields,
               double * params,
...
template <typename part, typename part_info, typename part_dataType>
void Particles<part,part_info,part_dataType>::moveParticles2( void (*move_funct)(double,double,part*,double *,part_info,Field<Real> **,Site *,int,double*,double*,int,FILE*),
                                                            double dtau,
                                                            Field<Real> ** fields,
                                                            int nfields,
                                                            double * params,
