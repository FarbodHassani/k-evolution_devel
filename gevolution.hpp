  ...
  //Credit: David  and Lorenzo!
    ...
    // cout.flags(f);
      ...
      //   n_correcor_steps Number of time which goes through predictor corrector method.
			...
			template <class FieldType>
			void update_pi_dot(double dtau, double dx, double a, Field<FieldType> & pi , Field<FieldType> & pi_dot, Field<FieldType> & det_gamma, double X_hat ,double g0, double g2, double g4, double Hcon)
			  {
