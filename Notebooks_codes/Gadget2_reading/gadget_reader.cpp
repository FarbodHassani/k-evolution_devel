// A code to read gadget snapshots format and according to some criteria make one or couple of new files
// By Farbod Hassani: August 2021, University of Oslo
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <math.h>
...
//   if (argc < 2)
//   {
//     cout << " Gadget reader - snapshot"<< "\n";
//     cout << " It reads gadget format snapshots and choose some particles from it" <<"\n";
//     cout << " List of command-line options:" << "\n";
//     cout << " -n <snapshot_number>  : number of gadget snapshots" << "\n";
//     cout << " -f <gadget file name>  : gadget file name (mandatory)" << "\n";
//     return 0;
//   }
//
...
//         break;
//       default:
//         cout <<  " error" << ": unknown command-line parameter " << argv[i] << endl << " call gadget reader without arguments to display help" << endl;
//         return -1;
//     }
//   }
//
...
//
//
//     // sprintf(path, "./output/gadget_snap");
//     // sprintf(basename, "gadget2_cdm");
...
//     // cout<<"header1.npart[0]: "<<header1.npart[0]<<"  "<< header1.npart[1]<< "  " << header1.npart[2]<<endl;
//     // cout<<"header1.npart[0]: "<<P..Pos[0]<<endl;
//
//   return 0;
// }
// load_snapshot(input_fname, files);
